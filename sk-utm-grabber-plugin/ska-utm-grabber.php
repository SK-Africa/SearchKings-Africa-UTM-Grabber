...
function ska_utm_grabber_anchor_shortcode() {
    ...
    return '<a id="sudonim-link" class="whatsapp-icon-wrapper" href="' . esc_url($base_url) . '"><svg class="whatsapp-icon" width="360" height="362" viewBox="0 0 360 362" fill="#ffffff" xmlns="http://www.w3.org/2000/svg">
