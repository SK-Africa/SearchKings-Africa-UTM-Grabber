...
function ska_utm_grabber_anchor_shortcode() {
    ...
    return '<a id="sudonim-link" class="whatsapp-icon-wrapper" href="' . esc_url($base_url) . '"><svg width="360" height="362" viewBox="0 0 360 362" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_2301_8)"><path d="M42.0878 319.717L57.7289 259.225L102.383 303.332L42.0878 319.717Z" fill="white"/><circle cx="179.5" cy="180.5" r="151.5" fill="white"/>
